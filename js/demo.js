 ...
 */
{
    ...
    class Overlay {
        constructor() {
            ...
            this.DOM.button = this.DOM.el.querySelector('.overlay__button');
        }
        show(contentItem) {
        ...
        revealItem() {
            ...
            itemElems.push(this.contentItem.querySelector('.overlay__text'));
            itemElems.push(this.contentItem.querySelector('.overlay__button'));
        ...
        hide() {
            ...
            // show revealer
            this.DOM.button.style.opacity = 0;
            TweenMax.to(this.DOM.reveal, .5, {
                //delay: 0.15,
                ease: 'Power3.easeOut',
                x: '0%',
